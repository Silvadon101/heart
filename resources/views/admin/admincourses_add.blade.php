...
<![endif]-->
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad addcoursepro">
                                                    <form action="admindash-courses-add"
                                                        class="dropzone dropzone-custom needsclick addcourse"
                                                        id="demo1-upload" method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                {{-- ---X----error---X--- --}}
                                                                <div class="form-group">
                                                                    <input name="start_date" id="start" type="text"
                                                                        class="form-control"
                                                                        placeholder="Course Start Date">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input name="end_date" id="finish" type="text"
                                                                        class="form-control"
    ...
    {{-- <script src="js-5/datepicker/listeners.js"></script> --}}
    <!-- form validate JS
    ============================================ -->
