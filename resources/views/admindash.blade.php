...
<head>
    ...
    <title>Heart/NSTA Trust | Dashbaord</title>
...
<div class="left-sidebar-pro">
    <nav id="sidebar" class="">
        <div class="sidebar-header">
            <a href="/"><img class="main-logo" src="img/heart-logo-icon.png" alt="" /></a>
            <strong><a href="index.html"><img src="img/heart-logo-icon.png" alt="" /></a></strong>
        </div>
                ...
                <ul class="metismenu" id="menu1">
                    ...
                    <li id="removable">
                        ...
                        <ul class="submenu-angle page-mini-nb-dp" aria-expanded="false">
                            <li><a title="Login" href="admin-log"><span class="mini-sub-pro">Login</span></a></li>
                            <li><a title="Register" href="admin-add"><span class="mini-sub-pro">Register</span></a></li>
                                        ...
                                        <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                            ...
                                            <li class="nav-item">
                                                <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                    ...
                                                    <span class="admin-name">{{ session('logadmin') }}</span>
...
<!-- counterup JS
    ============================================ -->
<script src="js-5/counterup/jquery.counterup.min.js"></script>
<script src="js-5/counterup/waypoints.min.js"></script>
<script src="js-5/counterup/counterup-active.js"></script>
<!-- mCustomScrollbar JS
    ============================================ -->
...
<!-- morrisjs JS
    ============================================ -->
<script src="js-5/morrisjs/raphael-min.js"></script>
<script src="js-5/morrisjs/morris.js"></script>
<script src="js-5/morrisjs/morris-active.js"></script>
<!-- morrisjs JS
    ============================================ -->
