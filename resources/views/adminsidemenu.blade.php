...
<div class="left-sidebar-pro">
    <nav id="sidebar" class="">
        <div class="sidebar-header">
            ...
            <strong><a href="/"><img src="img/heart-logo-icon.png" alt="" /></a></strong>
        </div>
            ...
            <nav class="sidebar-nav left-sidebar-menu-pro">
                <ul class="metismenu" id="menu1">
                    ...
                    <li class="active">
                        ...
                        <ul class="submenu-angle" aria-expanded="false">
                            <li><a title="All Courses" href="admindash-courses"><span class="mini-sub-pro">All Courses</span></a></li>
                            <li><a title="Add Courses" href="admindash-courses-add"><span class="mini-sub-pro">Add Course</span></a></li>
