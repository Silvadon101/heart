                ...
                w = function (i, s, n) {
                    ...
                    if (
                        (e.each(o, function (e, i) {
                            var s = i[1];
                            return a.substr(c, s.length).toLowerCase() ===
                                s.toLowerCase()
                                ? ((r = i[0]), (c += s.length), !1)
                                : t;
                        }),
            ...
            for (
                ...
                for (w = "", this.maxRows = 4, M = 0; q[1] > M; M++) {
                    if (
                        ...
                        if (
                            ((I += "<div class='ui-datepicker-group"), q[1] > 1)
                        )
                            switch (M) {
                                case 0:
                    ...
                    for (
                        ...
                        for (
                            ...
                            (j = f
                                ? f.apply(e.input ? e.input[0] : null, [F])
                                : [!0, ""]),
                                (K = F.getMonth() !== Z),
                                (R =
                                    (K && !v) ||
